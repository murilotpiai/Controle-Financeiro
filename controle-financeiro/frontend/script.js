...
const btnLimparFiltros = show("btnLimparFiltros"); // << NOVO
...
btnLimparFiltros.addEventListener("click", () => {
  ...
  filtroDataIni.value = "";
  filtroDataFim.value = "";
  refresh(); // redesenha KPIs, gráficos e tabela sem filtros
});
...
function exportExcel(){
  ...
  // Fallback: HTML que o Excel abre (.xls)
...
// Helpers de HTML para fallbacks
